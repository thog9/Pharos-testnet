...
CONTRACT_ADDRESS = "0xb2ac4f09735007562c513ebbe152a8d7fa682bef"
...
LANG = {
    'vi': {
        ...
        'success': '✅ Mint NFT Gotchipus Testnet Badge thành công!',
        'failure': '❌ Mint NFT Gotchipus Testnet Badge thất bại',
    ...
    'en': {
        ...
        'success': '✅ Successfully minted NFT Gotchipus Testnet Badge!',
        'failure': '❌ Failed to mint NFT Gotchipus Testnet Badge',
...
# Hàm chính
async def run_mintbadgegotchipus(language: str = 'vi'):
    print()
...
if __name__ == "__main__":
    asyncio.run(run_mintbadgegotchipus('vi'))
