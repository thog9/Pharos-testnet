...
CONFT_NFT_ADDRESS = "0x5a9525389B2c53c56BC3a2e4Fcdb4DC88326550d"
...
CONFIG = {
    ...
    "MAX_CONCURRENCY": 2,
    "MAX_RETRIES": 3,
    "MINIMUM_BALANCE": 0.0000001,  # PHRS
    "DEFAULT_GAS": 150000
}
...
LANG = {
    'vi': {
        'title': '✨ MINT CONFT NFT - PHAROS TESTNET ✨',
        'info': 'ℹ Thông tin',
        'found': 'Tìm thấy',
        'wallets': 'ví',
        ...
        'has_nft': 'Ví này đã mint Conft NFT! Không thực hiện lại',
        'no_balance': 'Số dư ví không đủ để mint (cần ít nhất {price:.6f} PHRS)',
        'preparing_tx': 'Đang chuẩn bị giao dịch...',
        'sending_tx': 'Đang gửi giao dịch...',
        'waiting_tx': 'Đang đợi xác nhận giao dịch...',
        'success': '✅ Mint NFT Community Member of Pharos thành công!',
        'failure': '❌ Mint NFT Community Member of Pharos thất bại',
    ...
    'en': {
        ...
        'has_nft': 'This wallet has already minted Conft NFT! Skipping',
        'no_balance': 'Insufficient balance to mint (need at least {price:.6f} PHRS)',
        'preparing_tx': 'Preparing transaction...',
        'sending_tx': 'Sending transaction...',
        'waiting_tx': 'Waiting for transaction confirmation...',
        'success': '✅ Successfully minted NFT Community Member of Pharos!',
        'failure': '❌ Failed to mint NFT Community Member of Pharos',
...
async def mint_conft_nft(w3: Web3, private_key: str, wallet_index: int, proxy: str = None, language: str = 'en'):
    ...
    for attempt in range(CONFIG['MAX_RETRIES']):
        try:
            ...
            print(f"{Fore.YELLOW}  - Giá mint: {w3.from_wei(mint_price, 'ether'):.6f} PHRS{Style.RESET_ALL}")
            ...
            try:
                ...
                gas_limit = int(estimated_gas * 1.3)  # Tăng 30%
