...
CONTRACT_ADDRESS = "0x96381ed3fcfb385cbacfe6908159f0905b19767a"
...
LANG = {
    'vi': {
        ...
        'success': '✅ Mint NFT Spout Testnet Badge thành công!',
        'failure': '❌ Mint NFT Spout Testnet Badge thất bại',
    ...
    'en': {
        ...
        'success': '✅ Successfully minted NFT Spout Testnet Badge!',
        'failure': '❌ Failed to mint NFT Spout Testnet Badge',
...
# Hàm chính
async def run_mintbadgespout(language: str = 'vi'):
    print()
...
if __name__ == "__main__":
    asyncio.run(run_mintbadgespout('vi'))
