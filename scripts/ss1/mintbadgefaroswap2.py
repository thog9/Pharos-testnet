...
CONTRACT_ADDRESS = "0x2a469a4073480596b9deb19f52aa89891ccff5ce"
...
LANG = {
    'vi': {
        ...
        'success': '✅ Mint NFT FaroSwap Testnet Badge thành công!',
        'failure': '❌ Mint NFT FaroSwap Testnet Badge thất bại',
    ...
    'en': {
        ...
        'success': '✅ Successfully minted NFT FaroSwap Testnet Badge!',
        'failure': '❌ Failed to mint NFT FaroSwap Testnet Badge',
...
# Hàm chính
async def run_mintbadgefaroswap2(language: str = 'vi'):
    print()
...
if __name__ == "__main__":
    asyncio.run(run_mintbadgefaroswap2('vi'))
