...
LANG = {
    'vi': {
        'title': '✨ GỬI GIAO DỊCH - PHAROS TESTNET ✨',
        'info': 'ℹ Thông tin',
        'found': 'Tìm thấy',
        'wallets': 'ví',
        ...
        'enter_amount': '✦ NHẬP SỐ LƯỢNG PHRS',
        'amount_prompt': 'Số lượng PHRS (mặc định 0.000001, tối đa 999): ',
        'amount_unit': 'PHRS',
    ...
    'en': {
        'title': '✨ SEND TRANSACTION - PHAROS TESTNET ✨',
        'info': 'ℹ Info',
        'found': 'Found',
        'wallets': 'wallets',
        ...
        'enter_amount': '✦ ENTER AMOUNT OF PHRS',
        'amount_prompt': 'Amount of PHRS (default 0.000001, max 999): ',
        'amount_unit': 'PHRS',
    ...
    for attempt in range(CONFIG['MAX_RETRIES']):
        try:
            ...
            if balance < required_balance:
                print(f"{Fore.RED}  ✖ {LANG[language]['insufficient_balance'].format(required=required_balance)}: {balance:.6f} PHRS{Style.RESET_ALL}")
                return False
