...
LANG = {
    'vi': {
        'title': '✨ TRIỂN KHAI TOKEN ERC20 - PHAROS TESTNET ✨',
        'info': 'ℹ Thông tin',
        'found': 'Tìm thấy',
        'wallets': 'ví',
    ...
    'en': {
        'title': '✨ DEPLOY ERC20 TOKEN - PHAROS TESTNET ✨',
        'info': 'ℹ Info',
        'found': 'Found',
        'wallets': 'wallets',
    ...
    for attempt in range(CONFIG['MAX_RETRIES']):
        try:
            ...
            if receipt is None:
                ...
                print(f"{Fore.YELLOW}    - {LANG[language]['balance']}: {w3.from_wei(w3.eth.get_balance(sender_address), 'ether'):.6f} PHRS{Style.RESET_ALL}")
